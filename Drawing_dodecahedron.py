...
while True:
    ...
    for i in range(5):
        ...
        connect_points(i+15, (i+1)%5+15, projected_points)
        connect_points(i, -2*((i+1)%5-4)+5, projected_points)
        connect_points(i+15, -2*((5-i)%5-7), projected_points)
    for j in range(10):
        connect_points(j+5, (j+1)%10+5, projected_points)
