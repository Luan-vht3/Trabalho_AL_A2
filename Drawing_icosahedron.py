...
pygame.display.set_caption("3d projection icosahedron")
...
while True:
    ...
    for i in range(5):
        connect_points(i, (i+1)%5, projected_points)
        connect_points(i+5, (i+1)%5+5, projected_points)

        connect_points(i, (i+5)%5+5, projected_points)
        connect_points(i, (i+6)%5+5, projected_points)

        connect_points(10, i, projected_points)
        connect_points(11, i+5, projected_points)
